namespace parkingManagementSystem
{
    partial class HistoryLogs
    {
        ...
        private void InitializeComponent()
        {
            ...
            filtersPanel.Margin = new Padding(0, 0, 0, 15);
            ...
            mainContainer.Controls.Add(filtersPanel, 0, 2);
            mainContainer.Controls.Add(tablePanel, 0, 3);
        ...
        // Built dynamically
        internal Label lblTotalCount, lblTotalRevenue, lblUnpaidAmount, lblAvgDuration;
        internal TextBox txtSearch;
        internal ComboBox cmbStatus, cmbCategory;
        internal DateTimePicker dtpFrom, dtpTo;
        internal DataGridView dgvHistory;
    }
}